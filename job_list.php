    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="box">
                ...
                <div class="box-body">
                    <form method="post" action="app/job_list_save.php">
                            ...
                            <div class="col-md-3">
                                <div class="form-group has-warning">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control" name="ins" style="width: 100%;" tabindex="1"
                                            autofocus>
                        ...
                        <table class=" table">
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php if($row['ins_type']=='1'){ echo "Paint";} 
                                    if($row['ins_type']=='2'){ echo "Tin";} ?></td>
                                </tr>
                                <?php } ?>
                            </tbody>
                        </table>
                        ...
                        <input type="hidden" name="end" value="pc">
                    </form>
                </div>
            </div>
            <!-- /.box-body -->
